...
export default function WelcomeEmail({ name, code, brochureLink }: WelcomeEmailProps) {
  return (
    <Html>
      <Head />
      ...
      <Body style={{ backgroundColor: '#f8f9fb', fontFamily: 'sans-serif' }}>
        <Container style={{ backgroundColor: '#ffffff', margin: '40px auto', padding: '40px', borderRadius: '8px', border: '1px solid #dae0e9', maxWidth: '500px' }}>
          ...
          <Text style={{ color: '#2c333d', fontSize: '16px', lineHeight: '1.5', margin: '0 0 24px 0' }}>
            To take the next step, please review our introductory brochure. Our team will then guide you through the opportunity details and payment instructions to lock in your offer.
          </Text>
          ...
          {/* Referral Code Block */}
          <Section style={{ backgroundColor: '#e6f0fa', padding: '20px', borderRadius: '8px', textAlign: 'center' as const, marginBottom: '32px' }}>
